...
import {
    Perfil,
    ProjectBusPoint, ProjectConsumeBrasilAPI,
    ProjectCourseFournel, ProjectEstouDeAcordo,
    ProjectGlassUI,
    ProjectLandwind,
    ProjectLogin,
    ProjectMeteora,
...
export default function Home() {
    ...
    function sendEmail(e: React.FormEvent<HTMLFormElement>) {
        ...
        emailjs
            ...
            .catch((err) => {
                ...
                console.log("Mensagem:", err?.text || err?.message);
    ...
    return (
        <div className="all-page">
            ...
            >
                ...
                <section className="hero lg:w-[878px] flex flex-col items-center">
                    <Image
                        ...
                        className="md:w-[424px] sm:w-[280px] w-[200px] md:mb-0 sm:mb-[57px] mb-11 transition-transform duration-300 ease-out hover:scale-110 hover:-translate-y-4"
                    />
            ...
            <section
                className="flex w-full py-[100px] xl:px-[172px] md:px-[113px] px-[11px] flex-col justify-center items-center gap-2.5 bg-black">
                <div className="flex flex-col justify-center items-center gap-[60px]">
                    ...
                    <div
                        className="flex lg:flex-row gap-[50px] flex-col w-full justify-between items-center self-stretch">
                        <div className="flex flex-col items-start gap-[55px]">
                            <div
                                className="flex  flex-col items-start pb-7 self-stretch border-b-[5px] border-primary transition-all duration-300 ease-out hover:-translate-y-1">
                        ...
                        <div
                            className="flex lg:w-[40%]  md:[w-full] sm:w-[80%] w-[75%] md:p-10 p-[30px] justify-center items-center content-center gap-y-[100px] gap-x-[65px] flex-wrap rounded-[100px] border border-border-skills">
            ...
            >
                <div className="flex flex-col justify-center items-center gap-[54px] w-[75%]">
                    ...
                    <div className="flex lg:flex-row flex-col items-center gap-[30px] self-stretch w-full">
                        <ProjectCard
                            imageSrc={ProjectEstouDeAcordo}
                            altText="Capa do projeto Estou de Acordo"
                            title="Estou de acordo"
                            description="“Estou de Acordo” is a rebranding project for Integral Sistemas, focused on transforming the product’s identity and repositioning it beyond the academic sector to reach a broader market."
                            projectLink="https://app.estoudeacordo.com.br/"
                        />
                        <ProjectCard
                            imageSrc={ProjectConsumeBrasilAPI}
                            altText="Capa do projeto Consume Brasil API"
                            title="Consume Brasil API"
                            description="Consumo do Brasil API is a project developed to strengthen knowledge of fetch and HTTP requests in JavaScript, focusing on practical implementation and better understanding of data consumption from external APIs."
                            projectLink="https://consume-brasil-api.vercel.app/"
                        />
                    </div>
                    <div className="flex lg:flex-row flex-col items-center gap-[30px] self-stretch w-full">
                        <ProjectCard
            ...
            >
                <div
                    className="flex md:flex-row flex-col py-[100px] md:px-0 px-[65px] justify-center items-center md:gap-[141px] gap-[75px] self-stretch">
                    <div
                        className="flex md:w-[45.572%] w-full flex-col md:items-start justify-center items-center gap-5">
                        <Image
                            src={Perfil}
                            alt="Minha foto de perfil"
                    ...
                    <div
                        className="flex p-10 flex-col justify-center items-center gap-[25px] rounded-xl bg-white md:w-[23%]">
                        ...
                        >
                            ...
                            <button
                                disabled={isSending}
                                className={`login flex py-[15px] px-[25px] justify-center items-center gap-2.5 rounded-[35px] border border-white text-xl w-full font-normal text-white transition-all duration-300 ease-out 
  ${
                                    isSending
                                        ? "bg-gray-400 cursor-not-allowed"
                                        : "bg-primary hover:bg-orange-700 hover:shadow-sm hover:-translate-y-1 cursor-pointer"
                                }`}
                                type="submit"
                            >
                                {isSending ? (
